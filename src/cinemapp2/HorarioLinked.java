 ...
 * @author MSI PC
 */
public class HorarioLinked {
      private int horario;
    private Silla[] sillas;
   private HorarioLinked next;
    
    
    public HorarioLinked(int horario) {
        this.next=null;
    ...
    public HorarioLinked getNext() {
        return next;
    }

    public void setNext(HorarioLinked next) {
        this.next = next;
    }
